...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&dnsListenHostPort, "dns-listen-host-port", "0.0.0.0:53", "dnsproxy listen address")
	rootCmd.PersistentFlags().StringVar(&dnsUpstreamHostPort, "dns-upstream-host-port", "8.8.8.8:53", "trusted upstream DNS server address")
